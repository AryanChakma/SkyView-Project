...
import './Weather.css'
import search_icon from '../assets/search-line.svg'
import clear_icon from '../assets/clear.svg'
import cloud_icon from '../assets/cloudy.svg'
import rain_icon from '../assets/rainy.svg'
  ...
  return (
    <div className='weather'>
        <div className="search-bar">
            ...
            <img src={search_icon} alt="" onClick={()=>search(inputRef.current.value)} className='search-icon'/>
        </div>
